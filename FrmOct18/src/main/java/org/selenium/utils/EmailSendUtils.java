 ...
 * org.selenium.java_Mail_API.EmailAttachmentsSender;
 * 
 * import javax.mail.MessagingException;
 * 
 * import static org.selenium.constants.FrameworkConstants.YES; import static
 * org.selenium.java_Mail_API.EmailConfig.*;
 * 
 ...
 *//**
	 ...
	 *//*
		 * public static void sendEmail(int count_totalTCs, int count_passedTCs, int
		 * count_failedTCs, int count_skippedTCs) {
		 * 
		 ...
		 * 
		 * String messageBody = getTestCasesCountInFormat(count_totalTCs,
		 * count_passedTCs, count_failedTCs, count_skippedTCs);
		 ...
		 * 
		 * 
		 * String attachmentFile_ExtentReport =
		 * FrameworkConstants.getExtentReportFilePath();
		 * 
		 * try { EmailAttachmentsSender.sendEmailWithAttachments(SERVER, PORT, FROM,
		 * PASSWORD, TO, SUBJECT, messageBody, attachmentFile_ExtentReport);
		 * 
		 * System.out.println("****************************************");
		 ...
		 * }
		 * 
		 * private static String getTestCasesCountInFormat(int count_totalTCs, int
		 * count_passedTCs, int count_failedTCs, int count_skippedTCs) {
